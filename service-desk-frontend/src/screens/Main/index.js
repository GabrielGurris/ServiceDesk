        ...
        <>
            <div className="row bg-danger">
                ...
                <div className="row ml-auto mr-auto mt-5 mb-5 align-items-center">
                    <div className="col-lg-4 col-sm-12 col-md-4 grow">
                    ...
                    <div className="col-md-4 col-sm-12 grow">
                        <Link to="#" className="text-dark text-decoration-none">
                            <div id="bcg" className="container text-center">
                                <h1 className="pt-3 pb-2">Saiba mais<br /></h1>
                                <h5 className="pb-3">Deseja saber sobre nosso site?<br />Clique aqui</h5>
                            </div>
                        </Link>
                    </div>
                </div>
